...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_product'])) {
    ...
    $stmt = $conn->prepare("UPDATE products SET product_name = :product_name, description = :description, product_price = :product_price, category_id = :category_id WHERE product_id = :product_id");
...
$products = $conn->query("
    SELECT products.product_id, products.product_name, products.description, products.product_price, categories.name AS category_name 
    FROM products 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO products (product_name, description, product_price, category_id) VALUES (:product_name, :description, :product_price, :category_id)");
    $stmt->bindValue(':product_name', $product_name);
    $stmt->bindValue(':description', $description);
    $stmt->bindValue(':product_price', $product_price);
    $stmt->bindValue(':category_id', $category_id);
                    ...
                    <td>
                        <button type="button" 
                            onclick="openEditForm(
                                '<?= htmlspecialchars($product['product_id'] ?? '', ENT_QUOTES) ?>', 
